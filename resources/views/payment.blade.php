  ...
  <div class="modal__container">
    <div class="modal__featured">
      ...
      <div class="modal__circle"></div>
        <img src="https://img.freepik.com/premium-photo/pink-shopping-bag-carries-shopping-trolley-blue-background-sales-aesthetic-shopping-cart_492182-387.jpg" class="modal__product" />
      </div>
    <div class="modal__content">
      ...
      <form>
        <ul class="form-list">
          ...
          <li>
            <button type="button" class="button" onclick="payement()">Pay Now</button>
          </li>
        </ul>
      </form>
...
<style>
  ...
  overflow-y: auto;
    ...
    .modal__container {
      ...
      margin-bottom: 20px;
      background-color: #ffffff;
      border-radius:modal__container 5px;
      box-shadow: 3px 3px 20px rgba(0, 0, 0, 0.1); }
    .modal__featured {
      position: relative;
      -ms-flex: 1;
